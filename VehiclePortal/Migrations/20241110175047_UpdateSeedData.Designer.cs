...
namespace VehiclePortal.Migrations
{
    ...
    [Migration("20241110175047_UpdateSeedData")]
            ...
            modelBuilder.Entity("VehiclePortal.Models.Listing", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedAt = new DateTime(2024, 11, 5, 18, 50, 44, 928, DateTimeKind.Local).AddTicks(9236),
                            Description = "Samochód w doskonałym stanie, niski przebieg, idealny dla rodziny.",
                            IsActive = true,
                            IsFeatured = true,
                            IsSold = false,
                            PostedDate = new DateTime(2024, 11, 5, 18, 50, 44, 928, DateTimeKind.Local).AddTicks(9170),
                            Price = 60000m,
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            CreatedAt = new DateTime(2024, 11, 7, 18, 50, 44, 928, DateTimeKind.Local).AddTicks(9248),
                            Description = "Mocna ciężarówka, idealna do pracy i rekreacji.",
                            IsActive = true,
                            IsFeatured = true,
                            IsSold = false,
                            PostedDate = new DateTime(2024, 11, 7, 18, 50, 44, 928, DateTimeKind.Local).AddTicks(9244),
                            Price = 95000m,
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 3,
                            CreatedAt = new DateTime(2024, 10, 31, 18, 50, 44, 928, DateTimeKind.Local).AddTicks(9255),
                            Description = "Klasyczny motocykl, w świetnym stanie, gotowy do jazdy.",
                            IsActive = false,
                            IsFeatured = false,
                            IsSold = true,
                            PostedDate = new DateTime(2024, 10, 31, 18, 50, 44, 928, DateTimeKind.Local).AddTicks(9252),
                            Price = 45000m,
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 4,
                            CreatedAt = new DateTime(2024, 11, 8, 18, 50, 44, 928, DateTimeKind.Local).AddTicks(9263),
                            Description = "Nowa opona zapasowa do BMW X5.",
                            IsActive = true,
                            IsFeatured = false,
                            IsSold = false,
                            PostedDate = new DateTime(2024, 11, 8, 18, 50, 44, 928, DateTimeKind.Local).AddTicks(9260),
                            Price = 1200m,
