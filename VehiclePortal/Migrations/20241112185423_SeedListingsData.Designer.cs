...
namespace VehiclePortal.Migrations
{
    ...
    [Migration("20241112185423_SeedListingsData")]
    partial class SeedListingsData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VehiclePortal.Models.Listing", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedAt = new DateTime(2024, 11, 12, 19, 54, 23, 72, DateTimeKind.Local).AddTicks(1126),
                            Description = "Wspaniały samochód w świetnym stanie.",
                            IsActive = true,
                            IsFeatured = true,
                            IsSold = false,
                            PostedDate = new DateTime(2024, 11, 12, 19, 54, 23, 72, DateTimeKind.Local).AddTicks(1072),
                            Price = 30000m,
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            CreatedAt = new DateTime(2024, 11, 12, 19, 54, 23, 72, DateTimeKind.Local).AddTicks(1134),
                            Description = "Ciężarówka w bardzo dobrym stanie.",
                            IsActive = true,
                            IsFeatured = true,
                            IsSold = false,
                            PostedDate = new DateTime(2024, 11, 12, 19, 54, 23, 72, DateTimeKind.Local).AddTicks(1133),
                            Price = 45000m,
