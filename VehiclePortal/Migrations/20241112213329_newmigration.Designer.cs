...
namespace VehiclePortal.Migrations
{
    ...
    [Migration("20241112213329_newmigration")]
            ...
            modelBuilder.Entity("VehiclePortal.Models.Listing", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedAt = new DateTime(2024, 11, 12, 22, 33, 29, 25, DateTimeKind.Local).AddTicks(8685),
                            Description = "Wspaniały samochód w świetnym stanie.",
                            IsActive = true,
                            IsFeatured = true,
                            IsSold = false,
                            PostedDate = new DateTime(2024, 11, 12, 22, 33, 29, 25, DateTimeKind.Local).AddTicks(8638),
                            Price = 30000m,
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            CreatedAt = new DateTime(2024, 11, 12, 22, 33, 29, 25, DateTimeKind.Local).AddTicks(8695),
                            Description = "Ciężarówka w bardzo dobrym stanie.",
                            IsActive = true,
                            IsFeatured = true,
                            IsSold = false,
                            PostedDate = new DateTime(2024, 11, 12, 22, 33, 29, 25, DateTimeKind.Local).AddTicks(8693),
                            Price = 45000m,
