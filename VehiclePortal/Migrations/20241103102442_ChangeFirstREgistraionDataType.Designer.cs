...
namespace VehiclePortal.Migrations
{
    ...
    [Migration("20241103102442_ChangeFirstREgistraionDataType")]
    partial class ChangeFirstREgistraionDataType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VehiclePortal.Models.Listing", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedAt = new DateTime(2024, 10, 29, 15, 24, 41, 840, DateTimeKind.Local).AddTicks(9652),
                            Description = "Excellent condition, low mileage, great family car.",
                            ImageUrl = "/images/listings/toyota_camry.jpg",
                            IsActive = true,
                            IsFeatured = true,
                            IsSold = false,
                            PostedDate = new DateTime(2024, 10, 29, 15, 24, 41, 840, DateTimeKind.Local).AddTicks(9636),
                            Price = 15000m,
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            CreatedAt = new DateTime(2024, 10, 31, 15, 24, 41, 840, DateTimeKind.Local).AddTicks(9656),
                            Description = "Powerful truck, perfect for work and leisure.",
                            ImageUrl = "/images/listings/ford_f150.jpg",
                            IsActive = true,
                            IsFeatured = true,
                            IsSold = false,
                            PostedDate = new DateTime(2024, 10, 31, 15, 24, 41, 840, DateTimeKind.Local).AddTicks(9655),
                            Price = 25000m,
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 3,
                            CreatedAt = new DateTime(2024, 10, 24, 15, 24, 41, 840, DateTimeKind.Local).AddTicks(9683),
                            Description = "Classic bike, in great shape, ready to ride.",
                            ImageUrl = "/images/listings/harley_davidson.jpg",
                            IsActive = false,
                            IsFeatured = false,
                            IsSold = true,
                            PostedDate = new DateTime(2024, 10, 24, 15, 24, 41, 840, DateTimeKind.Local).AddTicks(9682),
                            Price = 12000m,
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 4,
                            CreatedAt = new DateTime(2024, 11, 1, 15, 24, 41, 840, DateTimeKind.Local).AddTicks(9685),
                            Description = "Brand new spare tire for BMW X5.",
                            ImageUrl = "/images/listings/bmw_x5_tire.jpg",
                            IsActive = true,
                            IsFeatured = false,
                            IsSold = false,
                            PostedDate = new DateTime(2024, 11, 1, 15, 24, 41, 840, DateTimeKind.Local).AddTicks(9684),
                            Price = 300m,
