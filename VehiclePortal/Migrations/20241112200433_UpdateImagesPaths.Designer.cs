...
namespace VehiclePortal.Migrations
{
    ...
    [Migration("20241112200433_UpdateImagesPaths")]
    partial class UpdateImagesPaths
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VehiclePortal.Models.Listing", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedAt = new DateTime(2024, 11, 12, 21, 4, 32, 559, DateTimeKind.Local).AddTicks(3351),
                            Description = "Wspaniały samochód w świetnym stanie.",
                            IsActive = true,
                            IsFeatured = true,
                            IsSold = false,
                            PostedDate = new DateTime(2024, 11, 12, 21, 4, 32, 559, DateTimeKind.Local).AddTicks(3311),
                            Price = 30000m,
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            CreatedAt = new DateTime(2024, 11, 12, 21, 4, 32, 559, DateTimeKind.Local).AddTicks(3360),
                            Description = "Ciężarówka w bardzo dobrym stanie.",
                            IsActive = true,
                            IsFeatured = true,
                            IsSold = false,
                            PostedDate = new DateTime(2024, 11, 12, 21, 4, 32, 559, DateTimeKind.Local).AddTicks(3358),
                            Price = 45000m,
