...
namespace VehiclePortal.Migrations
{
    ...
    [Migration("20241029142000_AddListingsAndRelatedEntities")]
    partial class AddListingsAndRelatedEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VehiclePortal.Models.Listing", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedAt = new DateTime(2024, 10, 24, 19, 20, 0, 468, DateTimeKind.Local).AddTicks(7894),
                            Description = "Excellent condition, low mileage, great family car.",
                            ImageUrl = "/images/listings/toyota_camry.jpg",
                            IsActive = true,
                            IsFeatured = true,
                            IsSold = false,
                            PostedDate = new DateTime(2024, 10, 24, 19, 20, 0, 468, DateTimeKind.Local).AddTicks(7880),
                            Price = 15000m,
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            CreatedAt = new DateTime(2024, 10, 26, 19, 20, 0, 468, DateTimeKind.Local).AddTicks(7897),
                            Description = "Powerful truck, perfect for work and leisure.",
                            ImageUrl = "/images/listings/ford_f150.jpg",
                            IsActive = true,
                            IsFeatured = true,
                            IsSold = false,
                            PostedDate = new DateTime(2024, 10, 26, 19, 20, 0, 468, DateTimeKind.Local).AddTicks(7896),
                            Price = 25000m,
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 3,
                            CreatedAt = new DateTime(2024, 10, 19, 19, 20, 0, 468, DateTimeKind.Local).AddTicks(7899),
                            Description = "Classic bike, in great shape, ready to ride.",
                            ImageUrl = "/images/listings/harley_davidson.jpg",
                            IsActive = false,
                            IsFeatured = false,
                            IsSold = true,
                            PostedDate = new DateTime(2024, 10, 19, 19, 20, 0, 468, DateTimeKind.Local).AddTicks(7898),
                            Price = 12000m,
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 4,
                            CreatedAt = new DateTime(2024, 10, 27, 19, 20, 0, 468, DateTimeKind.Local).AddTicks(7901),
                            Description = "Brand new spare tire for BMW X5.",
                            ImageUrl = "/images/listings/bmw_x5_tire.jpg",
                            IsActive = true,
                            IsFeatured = false,
                            IsSold = false,
                            PostedDate = new DateTime(2024, 10, 27, 19, 20, 0, 468, DateTimeKind.Local).AddTicks(7901),
                            Price = 300m,
